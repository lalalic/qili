...
const httpServer=config.httpServer=server.listen(config.server.port, '0.0.0.0')
...
require("./subscription").extend({server:httpServer,config, path:`/${config.version}/websocket`})
