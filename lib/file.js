...
exports.resolver={
	...
	Mutation:{
		...
		file_tokens(_,{count=1},{app:{app:{apiKey}},user:{sessionToken}}){
...
exports.verify=(req, res, body)=>{
	...
	return qiniu.util.isQiniuCallback(req.originalUrl, body.toString(), req.getHeader('Authorization'))
}
