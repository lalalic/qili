...
class ChatAlibabaTongyi extends BaseChatModel {
    ...
    constructor(fields = {}) {
        ...
        this.apiUrl =`https://dashscope.aliyuncs.com/api/v1/services/aigc/${this.modelName.indexOf('-vl')!=-1 ? 'multimodal' : 'text'}-generation/generation`
    }
    ...
    async _generate(messages, options, runManager) {
        ...
        const { text } = data.output.choices[0].message.content[0];
