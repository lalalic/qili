...
class Node{
    constructor(){
        this.label = 'Alibaba Qwen'
        this.name = 'tongyi'
        this.version = 1.0
        this.type = 'alitongyi'
        this.icon = 'fake.svg'
        this.category = 'Chat Models'
        this.description = 'Chat completion using Alibaba Qwen'
        ...
        this.inputs = [
            {
                ...
                default: 'qwen-turbo',
                options:[
                    {label:'qwen-turbo(6k)',name:"qwen-turbo"},
                    {label:"qwen-plus(30k)",name:"qwen-plus"},
                    {label:'qwen-max(6k)',name:"qwen-max"},
                    {label:'qwen-max-longcontext(28k)', name:"qwen-max-longcontext"},
                    {label:"qwen-vl-plus", name:"qwen-vl-plus"},
                    {label:"qwen-vl-max",name:"qwen-vl-max"}
