...
class ChatflowToolNode{
    ...
    async init({inputs:{selectedChatflow, description, patch}, id}, _, {appDataSource, databaseEntities}){
        ...
        return new DynamicTool({
            ...
            async func(question, runManager){
                const result=await runManager.metadata.predict(selectedChatflow, id, {question, overrideConfig:patch}, runManager.runId)
                return result
            }
        })
    }
