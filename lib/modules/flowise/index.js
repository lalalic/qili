exports.Flowise=function Flowise({initFlowise=async a=>a}){
    ...
    return {
        ...
        static(service){
            return new Promise(async (resolve)=>{
                ...
                await exports.extendServerNodes(serverApp)
                await serverApp.config()

                await initFlowise({flowise:serverApp, qili:app})
                resolve()
            })
        },
        finalize(){
...
exports.extendServerNodes=function extendNodes(serverApp){
