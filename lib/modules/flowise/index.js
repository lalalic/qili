...
exports.Flowise=function Flowise({init, finalize, static:staticFx,extendFlowiseNodes, flowiseRootPath="/", ...props}){
    ...
    process.env.DATABASE_HOST="qili"
    ...
    return {
        ...
        init(app){
            ...
            ;(async()=>{
                ...
                await extendFlowiseNodes({flowise, qili:app, extendFlowise:()=>extendFlowise({flowise, qili:app})})
...
exports.prepareQiliDatasource=function prepareQiliDatasource(qili){
    ...
    monkeyIntercept(DriverFactory.prototype, 'create', fx=>function(datasource){
        debugger
        if(datasource.options.host=="qili"){
