...
function makeAllNodesMetadataReady(allNodes, qili, flowise) {
    allNodes.forEach(a => {
        monkeyIntercept(a.constructor.prototype, 'init' ,fx => async function ({id,name, credential, inputs, ctx},_, options) {
            const langchainNode = await fx.call(this, ...arguments, qili, flowise, ctx)
