...
function extendBuildLangChain(flowise){
    ...
    monkeyIntercept(flowise.constructor.prototype.Utils,'getEndingNode', fx=>function(){
        return getEndingNode(...arguments)
    })

    monkeyIntercept(flowise.constructor.prototype.Utils,'constructGraphs', fx=>function(nodes,edges,isNondirected=false){
