...
exports.resolver={
	...
	Query: {
		version:(_,{},{app})=>app.app.version,
		schema(_,{},{app}){
			return app.printableSchema
		}
	},
	User:{
		id:exports.ID,
		...
		token(user,{expiresIn="1y"},{app}){
			return app.encode({_id:user._id}, {expiresIn})
		},
	...
	Mutation: {
		...
		deleteAccount(_,{},{app,user}){
			app.remove1Entity("User",{_id:user._id})
			app.emit('deleteAccount',user)
			return true
		}
	},
	Subscription:{
